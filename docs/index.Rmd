...
layer:
    1. yintercept: year_average
       geom: hline
    2. mapping: x = DAY, ymin = TMIN, ymax = TMAX
       geom: rect
...
```{r ggplotly-sx-facet, echo = TRUE, fig.height = 5.5, fig.width = 11, dpi = 72}
```

---

```{r plotly-sx-facet, echo = TRUE, fig.height = 5.5, fig.width = 11, dpi = 72}
```
